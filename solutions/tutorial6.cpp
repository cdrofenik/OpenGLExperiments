...
int tutorial_6(GLFWwindow* window)
{
	...
	window = glfwCreateWindow(1024, 768, "Tutorial 6: Keyboard and mouse movement", NULL, NULL); // (In the accompanying source code, this variable is global) 
	if (window == NULL){
	...
	//GLuint Texture = loadDDS("..\\external\\textures\\uvtemplate.DDS");
