...
int tutorial_4(GLFWwindow* window)
{
	...
	window = glfwCreateWindow(1024, 768, "Tutorial 4: Basic Cube", NULL, NULL); // (In the accompanying source code, this variable is global) 
	if (window == NULL){
	...
	GLuint programID = LoadShaders("..\\external\\shaders\\tutorial4.vert", "..\\external\\shaders\\tutorial4.frag");
