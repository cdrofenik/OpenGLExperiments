...
#include "../external/common/vboindexer.hpp"
...
int tutorial_11(GLFWwindow* window)
{
	...
	window = glfwCreateWindow(1024, 768, "Tutorial 11: 2D Text", NULL, NULL); // (In the accompanying source code, this variable is global) 
	if (window == NULL){
	...
	initText2D("..\\external\\textures\\Holstein.DDS");
